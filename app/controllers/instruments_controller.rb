class InstrumentsController < ApplicationController
  before_action :set_instrument, only: %i[ show edit update destroy ] #bu fonksiyonlardan once set_instrument çalıştır
  before_action :authenticate_user!, except: %i[index, show] #bu fonksiyonlar dışında hepsinden önce authenticate_user çalıştır
